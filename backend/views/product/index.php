        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                  ...
                  'filterOptions' => ['class' => 'text-center','width' => '80'],
                  ...
                  'content' => function($data)
                  {
                    if($file = $data->getImage()):
                      return (Html::a(Html::img($file->getUrl('600x600'),['style'=>'width:100%']),$file->getUrl('600x600'),[/*'rel' => 'galery',*/ 'class' => 'photo']));
                    endif;
                  }
                ],
                'new',
